	...
	return (
		<ServiceSection id='services'>
			...
			<Content ref={addToRefs}>
				<TextBlock
					topic='Design'
					title={<h1 className='text-shades-white'>We build award winning Designs</h1>}
					subText={
						<h5 className='text-shades-white'>
			...
			<Content ref={addToRefs}>
				<TextBlock
					topic='Develop'
					title={<h1 className='text-shades-white'>We Develope high quality Web & App</h1>}
					subText={
						<h5 className='text-shades-white'>
			...
			<Content>
				<TextBlock
					topic='Support'
					title={<h1 className='text-shades-white'>We provide support for your digital presence</h1>}
					subText={
						<h5 className='text-shades-white'>
				...
				/>
				<OBJ>
					<Image src={Capsule} alt='Capsule Object' width='400' height='400' />
				</OBJ>
