...
const HeroSection = () => {
  return (
    <HomeSection id="home">
      <Blobs>
        <PinkBlob>
          <Image src={pinkBlob} alt="Pink Blob" width={400} height={400} />
        </PinkBlob>
        <WhiteBlob>
          <Image src={whiteBlob} alt="White Blob" width={400} height={400} />
        </WhiteBlob>
        <PurpleBlob>
          <Image src={purpleBlob} alt="Purple Blob" width={400} height={400} />
        </PurpleBlob>
      </Blobs>
