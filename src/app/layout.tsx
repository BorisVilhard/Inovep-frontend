...
const Layout = ({ children }: { children: ReactNode }) => {
	...
	const handleGoogleSuccess = async (credentialResponse: any) => {
		try {
			...
			if (response.status >= 200 && response.status < 300) {
				...
				store.setCredentials(id, username, email, accessToken); // Sets firstTimeLogin to true
	...
	return (
		<GoogleOAuthProvider
			clientId={
				'144138078197-u35dcpt8s6nd044f33b90098dfpsisns.apps.googleusercontent.com'
			}
		>
			<html lang='en'>
				<head />
